...
<body style="background-image: url(../img/bg_1.jpg); height: 100%; width: 100%; background-size: cover;">
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select r.name,a.street,a.zipcode,l.state,l.country from restaurant r,address a,location l where r.aid=a.aid and a.cid=l.cid"></asp:SqlDataSource>
